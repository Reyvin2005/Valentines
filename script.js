function showMessage(response) {
  ...
  if (response === "No") {
    ...
    noButton.addEventListener("mouseover", () => {
      if (!videoPlayed) {
        ...
        videoElement.src = "./Restless Heart - When She Cries.mp4#t=52";
  ...
  if (response === "Yes") {
    ...
    yesMessage.textContent = "YEHEY DATE WITH MY LOVEY ON 14 and 15!!! and my Valentines FOREVER!!!";
    yesMessage.style.display = "block";
    yesMessage.style.fontStyle = "normal";
    document.getElementsByClassName("image")[0].src = "https://media1.tenor.com/m/6Ljq-avCWI4AAAAC/red-panda.gif";
